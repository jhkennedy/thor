function [SET, NPOLY, NMIGRE] = stepStrainMigReRelax(NAMES, SET, StrainStep, RUN, STEP, SAVE, eigenMask )
...
%   Thor.Utilities.migre, and Thor.Utilities.rotate.
    ...
    for ii = 1:SET.nelem
        ...
        [cdist, rhoDotStrain] = Thor.Utilities.disl(cdist, SET, ii);
        ...
        [cdist, SET, NMIGRE(ii,:)] = Thor.Utilities.migReRelax(cdist, SET, ii, eigenMask, rhoDotStrain);
