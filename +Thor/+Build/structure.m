...
load ./+Thor/+Build/Settings/DEFAULT.mat
...
% Construct the Crystal Distrobution components
    ...
    % Number of crystals
    Hnumbcrys    = uicontrol('Style','popupmenu','Value',9,...
    ...
    Hcontype    = uicontrol('Style', 'popupmenu','Value',1,...
    ...
    % Distrobution type
    Hdistype    = uicontrol('Style', 'popupmenu','Value',1,...
                            'String', 'Isotropic',...
...
% Construct the Element wide components
    ...
    % Number of elements
    Hnelem       = uicontrol('Style', 'edit','String','1',...
...
% Construct the model wide components
    ...
    Hynsoft     = uicontrol('Style', 'checkbox', 'Value',1,...
    ...
    % Softness parameter
    Hsoft       = uicontrol('Style', 'edit','String','0',...
    ...
    % Time Step Size
    Hconangle    = uicontrol('Style', 'edit','String','100',...
    ...
    % Time Step Units
    Hglenexp     = uicontrol('Style','popupmenu','Value',5,...
